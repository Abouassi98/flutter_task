...
Future<ProviderContainer> _mainInitializer() async {
  ...
  widgetsBinding.addPostFrameCallback((_) async {
    ...
    await _precacheAssets(
      context,
      container.read(androidDeviceInfoProvider).isAndroid12AndHigher,
    );
...
Future<void> _precacheAssets(
  ...
  bool isAndroid12AndHigher,
) async {
  await <Future<void>>[
    SplashScreen.precacheAssets(
      context,
      isAndroid12AndHigher: isAndroid12AndHigher,
    ),
  ].wait.suppressError();
}
