...
class LoggingInterceptor extends Interceptor {
  ...
  void onResponse(
    ...
    log('LogInterceptor: RESPONSE[${response.statusCode}] => PATH: ${response.requestOptions.path}'
        ' => QueryParams: ${response.requestOptions.queryParameters} => DATA: ${response.data}');
