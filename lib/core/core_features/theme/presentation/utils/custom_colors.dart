...
class CustomColors extends ThemeExtension<CustomColors> {
  ...
  CustomColors copyWith({
    ...
    return CustomColors(
      fullScreenScaffoldColor:
          fullScreenScaffoldColor ?? this.fullScreenScaffoldColor,
  ...
  CustomColors lerp(ThemeExtension<CustomColors>? other, double t) {
    ...
    return CustomColors(
      fullScreenScaffoldColor: Color.lerp(fullScreenScaffoldColor, other.fullScreenScaffoldColor, t),
      ...
      carolinaBlueColor:
          Color.lerp(carolinaBlueColor, other.carolinaBlueColor, t),
