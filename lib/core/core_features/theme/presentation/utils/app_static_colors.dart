...
abstract class AppStaticColors {
  ...
  static const Color orange = Color(0xFFFF8E42);
  static const Color black1 = Color(0xFF032326);
  static const Color normalBlack = Colors.black;
  static const Color blueLogin = Color(0xFF0000CE);
  static const Color backGround = Color(0xFFF5F5F9);
  static const Color errorBoarderColor = Color(0xFFF84711);
