...
class AppTheme {
  ...
  late final NavigationBarThemeData _navigationBarTheme =
    ...
    labelTextStyle: MaterialStateProperty.resolveWith((states) {
      if (states.contains(MaterialState.selected)) {
        return TextStyles.navigationLabel(_appColors.primary);
      }
      return TextStyles.navigationLabel(_appColors.customColors.greyColor!);
    }),
  ...
  late final InputDecorationTheme _inputDecorationTheme = InputDecorationTheme(
    ...
    border: Borders.enabledBorderStyle(_appColors.textFieldBorderColor),
    enabledBorder:
        Borders.enabledBorderStyle(_appColors.textFieldEnabledBorderColor),
    focusedBorder:
        Borders.enabledBorderStyle(_appColors.textFieldFocusedBorderColor),
    errorBorder: Borders.errorBorderStyle(_appColors.textFieldErrorBorderColor),
    focusedErrorBorder:
        Borders.errorBorderStyle(_appColors.textFieldErrorBorderColor),
    errorStyle:
  ...
  late final DialogTheme _dialogTheme = DialogTheme(
    backgroundColor: _appColors.customColors.whiteColor,
    titleTextStyle:
